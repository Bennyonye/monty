...
ii.All your files will be compiled on Ubuntu 20.04 LTS using gcc, using the options -Wall -Werror -Wextra -pedantic -std=c89
...
vi. You allowed to use a maximum of one global variable
vii. No more than 5 functions per file
viii. You are allowed to use the C standard library
ix. The prototypes of all your functions should be included in your header file called monty.h
x. Don’t forget to push your header file
xi. All your header files should be include guarded
xii. You are expected to do the tasks in the order shown in the project
